 ...
 */
public class SpecialMethodInvocationEntry {

	protected String className;
	protected String methodName;
	protected String methodSignature;
	
	public SpecialMethodInvocationEntry(String className, String methodName, String methodSignature) {
		super();
	...
	public boolean equals(Object obj) {
		if(obj != null && obj instanceof SpecialMethodInvocationEntry) {
			SpecialMethodInvocationEntry otherObj = (SpecialMethodInvocationEntry)obj;
